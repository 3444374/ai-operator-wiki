...
该系统由 [[entities/huawei|华为]] 与 [[entities/tsinghua-university|清华大学]] 联合提出并实现，算法范围聚焦于传统机器学习（分类、回归、聚类等），不涉及大语言模型或 embedding。
## 相关实体
...
- "Li, Sun, Li, Wang, Nie, Xu. *GaussML: An End-to-End In-database Machine Learning System.* ICDE 2024." — [[raw/papers/gaussml_icde2024|gaussml_icde2024]]